...
public class RegisterForm {
    ...
    public RegisterForm fillTitle(Title title) {
        switch (title) {
            case MR -> MR.click();
            case MRS -> MRS.click();
        }
    ...
    public RegisterForm fillName(String name) {
    ...
    public RegisterForm setDateOfBirth(int day, String month, int year) {
    ...
    public RegisterForm signUpForNewsletter(boolean sign) {
        if (sign) NEWSLETTER.click();
        return this;
    }

    public RegisterForm signUpForPartners(boolean sign) {
        if (sign) OPTIN.click();
        return this;
    }
    ...
    public RegisterForm fillCompany(String company) {
    ...
    public RegisterForm fillAddress2(String address) {
        ADDRESS2.setValue(address);
        return this;
    }

    public RegisterForm setCountry(Country country) {
        COUNTRY.selectOption(country.getName());
        return this;
    }

    public RegisterForm fillState(String state) {
    ...
    public RegisterForm fillZipcode(String zipcode) {
        ZIPCODE.setValue(zipcode);
        return this;
    }

    public RegisterForm fillMobilePhone(String mobilePhone) {
